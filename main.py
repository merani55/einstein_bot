...
QUEST = [
    ...
    {
        "title": "Точка 5 — Місце формування генія",
        "text": "«Початок шляху — у стінах, де відлунюють думки юності.»",
        "question": "Як називається заклад, що знаходився за адресою Müllerstraße 11, де молодий Ейнштейн розпочинав свій  шлях до великих відкриттів?",
